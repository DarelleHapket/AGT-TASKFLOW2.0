// frontend/src/components/dashboard/SectionDemandes.jsx
//
// Liste des demandes de compte en attente de validation, avec action
// directe. Affichée seulement si l'utilisateur a la permission
// members.manage (superadmin/admin par défaut).
  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
        ...
        {onGoToTeam && (
          <button onClick={onGoToTeam} style={{
