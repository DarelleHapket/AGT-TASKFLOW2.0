...
_Ce fichier ne doit pas être réorganisé sans accord explicite de Josué._  
_Décisions numérotées D-xx en continu commun avec le Poste B (dernière en date : D-12)._

## Poste B — Darelle

### Auth & Rôles

- [x] RBAC 3 rôles (admin/chef_projet/membre)
- [x] require_role + role dans token/login/me
- [x] Désignation chef d'un projet (admin)

### Difficultés

- [x] Filtrage backend par projet du chef
- [x] Cloche ouverte au chef

### Rapports

- [x] Bug dates get_date_range corrigé
- [x] Filtrage par rôle (membre/chef/admin)
- [x] Rapport par projet
- [x] Export TXT + PDF

### Ma Journée

- [x] Gestion personnelle par le membre
- [x] Plages horaires + surlignage temps réel
- [ ] (abandonné) notifications push

### Notes

- [x] Auth + auteur + lecture publique + droits

### Reste à faire (P2)

- [ ] Besoins (needs)
- [ ] Performances (performance)
- [ ] Coordination B-open-2 avec Josué (projet obligatoire sur tâche)
