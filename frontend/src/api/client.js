...
export const getDailyOrder     = (memberId, date) => req("GET", `/daily-order/?member_id=${memberId}&date=${date}`);
export const setDailyOrderBulk = (data)           => req("POST", "/daily-order/bulk", data);
